...
typedef enum {
  ...
  PORT_NO_SERIAL_COM1_DATA = 0x03f8 + 1,
  PORT_NO_SERIAL_COM1_CMD_FIFO = 0x03f8 + 2,
  PORT_NO_SERIAL_COM1_CMD_LINE = 0x03f8 + 3,
  PORT_NO_SERIAL_COM1_CMD_MODEM = 0x03f8 + 4,
  PORT_NO_SERIAL_COM1_STATUS_LINE = 0x03f8 + 5,
} port_no_t;
